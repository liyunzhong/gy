<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="domin.aspx.cs" Inherits="UI.apps.domin" %>
<!DOCTYPE html>
<html>
                                                    ...
                                                    <select  required name="Userid">
                                                        <option value="">选择学生</option>
                                                          <% 
                                                              if (list1.Count > 0)
                                                              {
                                                                  foreach (Dormitory.Model.users item in list1)
                                                                  {
                        %>
                                                    ...
                                                    <select required name="Roomid">
                                                        <option value="">选择公寓</option>
                                                          <% 
                                                              if (list.Count > 0)
                                                              {
                                                                  foreach (Dormitory.Model.Room item in list)
                                                                  {
                        %>

                                                        <option value="<%=item.Id %>">
                                                            校区：<%=item.Dh %>，栋号：<%=item.Dh %>-<%=item.Lc %>
                                                        </option>
                                                        <% }
                                                              } %>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="RNo"  class="gui-input" placeholder="">
                                                    </label>
                                                    <label for="sm2" class="button btn-primary">床位号</label>
                                                </div>
