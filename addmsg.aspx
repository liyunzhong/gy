<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addmsg.aspx.cs" Inherits="UI.apps.addmsg" %>
<!DOCTYPE html>
<html>
                ...
                <div class="mw1000 ">
                    ...
                    <div class="allcp-form theme-primary">
                        <div class="panel">
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Subject"  class="gui-input" placeholder="">
                                                    </label>
                                                    <label for="sm2" class="button btn-primary">意见标题</label>
                                                </div>
                            ...
                            <textarea class="gui-textarea" name="Contents" placeholder="意见内容"></textarea>
