<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addfix.aspx.cs" Inherits="UI.apps.addfix" %>
<!DOCTYPE html>
<html>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Thing"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Reason"  class="gui-input" placeholder="">
                                                    </label>
