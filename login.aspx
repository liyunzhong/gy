<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="UI.apps.login" %>
<!DOCTYPE html>
<html>
                        ...
                        <div class="panel-body pn mv10">
                            ...
                            <div class="section">
                                <label for="password" class="field prepend-icon">
                                    <input type="text" required name="password" id="password" class="gui-input"
                                           placeholder="密码">
                            ...
                            <div class="section">
                                <div class="bs-component pull-left pt5">
                                    <div class="radio-custom radio-primary mb5 lh25">
                                        <input checked
                                             type="radio" id="remember" name="remember">
