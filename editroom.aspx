<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editroom.aspx.cs" Inherits="UI.apps.editroom" %>
<!DOCTYPE html>
<html>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-80">
                                                    <label class="field">
                                                        <input type="text" required value="<%=model.Area %>" name="Area"  class="gui-input" placeholder="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-80">
                                                    <label class="field">
                                                        <input type="text" required value="<%=model.Lc %>" name="Lc"  class="gui-input" placeholder="">
                                                    </label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required value="<%=model.Sex %>" name="Sex"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" value="<%=model.Roomnum %>" required name="Roomnum"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required value="<%=model.Roomusers %>" name="Roomusers"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required value="<%=model.Price %>" name="Price"  class="gui-input" placeholder="">
                                                    </label>
