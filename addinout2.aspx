<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addinout2.aspx.cs" Inherits="UI.apps.addinout2" %>
<!DOCTYPE html>
<html>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Calluser"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Cards"  class="gui-input" placeholder="">
                                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" required name="Outdate"  class="gui-input" placeholder="">
                                                    </label>
