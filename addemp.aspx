<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addemp.aspx.cs" Inherits="UI.apps.addemp" %>
<!DOCTYPE html>
<html>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" name="addressfloor" required class="gui-input" placeholder="">
                                                    </label>
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" name="addressroom" required class="gui-input" placeholder="">
                                                    </label>
