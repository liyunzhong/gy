<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editinout1.aspx.cs" Inherits="UI.apps.editinout1" %>
<!DOCTYPE html>
<html>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" value="<%=model.Wplx %>" required name="Wplx"  class="gui-input" placeholder="">
                                                    </label>
                                                ...
                                                <label class="field select">
                                                    <select id="country" required name="Type">
                                                        <option value="">出入类型</option>
                                                         <option <% if(model.Type==1){ %>selected <% } %> value="1" >带入</option>
                                                        <option <% if(model.Type==2){ %>selected <% } %> value="2" >带出</option>
