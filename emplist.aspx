<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emplist.aspx.cs" Inherits="UI.apps.emplist" %>
<!DOCTYPE html>
<html>
                    ...
                    foreach (Dormitory.Model.users item in list)
                    {
                        %>
                                    <tr>
                                        ...
                                        <td><%=item.sex %></td>
                                        <td><%=item.address %></td>
                                        <td><%=item.addressfloor %></td>
                                        <td><%=item.addressroom %></td>
                                        <td>

                                            <a class="btn btn-primary" href="editemp.aspx?id=<%=item.id %>">更新</a>

                                            <a class="btn btn-danger" href="deldata.aspx?ret=emplist&tab=users&id=<%=item.id %>">删除</a>
                                        </td>
                                    </tr>
