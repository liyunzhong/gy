<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlist.aspx.cs" Inherits="UI.apps.adminlist" %>
<!DOCTYPE html>
<html>
                        ...
                        %>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary" href="profile.aspx?id=<%=item.id %>">更新</a>
                                            <a class="btn btn-warning" href="password.aspx?id=<%=item.id %>">密码设置</a>

                                            <a class="btn btn-danger" href="deldata.aspx?ret=adminlist&tab=users&id=<%=item.id %>">删除</a>
                                        </td>
                                    </tr>
