<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="msglist.aspx.cs" Inherits="UI.apps.msglist" %>
<!DOCTYPE html>
<html>
    ...
    <section id="">
        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="chute chute-center">
                ...
                if (list.Count > 0)
                {
                    foreach (Dormitory.Model.Helpinfo item in list)
                    {
                        %>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" href="deldata.aspx?ret=msglist&tab=Helpinfo&id=<%=item.Id %>">删除</a>
                                        </td>
                                    </tr>
