<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addout.aspx.cs" Inherits="UI.apps.addout" %>
<!DOCTYPE html>
<html>
                ...
                <div class="mw1000 ">
                    ...
                    <div class="allcp-form theme-primary">
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                <label class="field select">
                                                    <select id="country" required name="id">
                        ...
                        %>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                ...
                                                <div class="smart-widget sm-left sml-80">
                                                    <label class="field">
                                                        <input type="text" required name="grade"  class="gui-input" placeholder="">
                                                    </label>
                                                    <label for="sm2" class="button btn-primary">学制</label>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="section">
                                                 <div class="smart-widget sm-left sml-120">
                                                    <label class="field">
                                                        <input type="text" onclick="WdatePicker()" name="outdate"  required class="gui-input" placeholder="">
                                                    </label>
                                                    <label for="sm2" class="button btn-primary">离校时间</label>
                                                </div>
                                        </div>
                                        </div>  </div>
                            ...
                            <textarea class="gui-textarea" name="outreason" placeholder="离校原因"></textarea>
